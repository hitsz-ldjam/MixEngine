...
//        auto equal = EpsilonEqual(transform().getPosition(), _target);
...
//            localDir = mGameObject->getParent()->transform().worldToLocalMatrix().multiplyDirection(dir);
//        else
//            localDir = dir;
...
//            lockFlag = !lockFlag;
//        }
//        if (Input::Get()->isButtonHold(ButtonCode::Gamepad_Y)) {
//            auto gameObject = GameObject::Find("TestBoomBox");
//            auto body = gameObject->getComponent<RigidBody>();
//            body->get().applyCentralForce({ 0.0f,150.0f,0.0f });
//        }
//        if (Input::Get()->isButtonHold(ButtonCode::Gamepad_A)) {
//            auto gameObject = GameObject::Find("TestBoomBox");
//            auto body = gameObject->getComponent<RigidBody>();
//            body->get().applyCentralForce({ 0.0f,-150.0f,0.0f });
//        }
...
//            auto gameObject = GameObject::Find("TestBoomBox");
//            auto body = gameObject->getComponent<RigidBody>();
//            body->get().applyCentralForce({ 0.0f,15.0f,0.0f });
//        }
