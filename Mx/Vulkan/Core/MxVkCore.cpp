...
//            SDL_Vulkan_CreateSurface(mWindow->window(), static_cast<VkInstance>(mInstance), &surface);
...
//        }
//
//        void Core::pickPhysicalDevice(const std::function<uint32_t(const PhysicalDeviceInfo&)>& _marker) {
...
//                const auto score = _marker ? _marker(deviceInfo) : evaluatePhysicalDevice(deviceInfo);
//                if (topScore <= score) {
//                    topScore = score;
//                    top = &deviceInfo;
//                }
...
//            mWindow = _window;
//            unsigned int count;
//            SDL_Vulkan_GetInstanceExtensions(_window->window(), &count, nullptr);
//            std::vector<const char*> extensions(count);
//            SDL_Vulkan_GetInstanceExtensions(_window->window(), &count, extensions.data());
