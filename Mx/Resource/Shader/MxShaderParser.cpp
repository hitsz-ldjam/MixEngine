...
namespace Mix {
	namespace Resource {
		std::shared_ptr<ResourceBase> ShaderParser::load(const std::filesystem::path& _path, const ResourceType _type) {
		...
		std::shared_ptr<ResourceBase> ShaderParser::load(const std::filesystem::path& _path, const std::string& _ext) {
			ResourceType type;
