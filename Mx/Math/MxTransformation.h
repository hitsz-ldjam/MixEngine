...
namespace Mix {
    namespace Math {
        ...
        public:
            ...
            static glm::mat4 MatrixFromTRS(const glm::vec3& _translate, const glm::quat& _rotation, const glm::vec3& _scale) {
        ...
        private:
            ...
            static glm::mat4 MatrixFromTransform(const glm::vec3& _position, const glm::quat& _rotation, const glm::vec3& _scale) {
                // Set rotation
