...
namespace Mix {
    ...
    public:
        ...
        // ---------- Internal ---------------
        std::shared_ptr<Vulkan::Buffer> getVertexBuffer() const { return mVertexBuffer; }

        std::shared_ptr<Vulkan::Buffer> getIndexBuffer() const { return mIndexBuffer; }

        const std::vector<SubMesh>& getSubMesh() const { return mSubMeshes; }
